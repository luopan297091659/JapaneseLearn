...
VALUES
  ...
  (UUID(), 'reading', '「学校」の読み方は？', 'がっこう',
   '["がっこう","がくせい","せんせい","だいがく"]', '学校 假名读音为 がっこう (gakkou)。', 'N5', NOW(), NOW()),
  (UUID(), 'reading', '「先生」の読み方は？', 'せんせい',
   '["がっこう","ともだち","せんせい","でんしゃ"]', '先生 假名读音为 せんせい (sensei)。', 'N5', NOW(), NOW()),
  ...
  (UUID(), 'meaning', '「電車」の意味は？', '电车/地铁',
   '["自行车","电车","公交车","出租车"]', '電車 (でんしゃ) means "train/subway"。', 'N5', NOW(), NOW());
