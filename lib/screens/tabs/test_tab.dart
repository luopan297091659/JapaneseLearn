        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                context.push('/game', extra: 'verbs');
              },
            ),
            const SizedBox(height: 8),
            ListTile(
              leading: const Text('🧩', style: TextStyle(fontSize: 28)),
              title: const Text('助词方块',
                  style: TextStyle(fontWeight: FontWeight.w700)),
              ...
              onTap: () {
                Navigator.pop(ctx);
                context.push('/game', extra: 'particles');
              },
            ),
            const SizedBox(height: 16),
          ],
    ...
    Widget body = ListView(
      ...
      children: [
        ...
        _TestCard(
          ...
          onTap: () {
            if (_isBlocked('kana_writing_modes')) {
              _showMemberDialog('五十音读写');
              return;
            }
        ...
        _TestCard(
          ...
          onTap: () {
            if (_isBlocked('quiz_meaning_daily')) {
              _showMemberDialog('单词测验');
              return;
            }
            context.push('/quiz');
          },
        ...
        _TestCard(
          ...
          onTap: () {
            if (_isBlocked('grammar_quiz_daily')) {
              _showMemberDialog('语法测验');
              return;
            }
        ...
        _TestCard(
          ...
          onTap: () {
            if (_isBlocked('listening_exercise_daily')) {
              _showMemberDialog('听力测验');
              return;
            }
        ...
        _TestCard(
          ...
          title: '闯关游戏',
          subtitle: '动词方块 · 助词方块 · 闯关挑战',
          color: const Color(0xFF4CAF50),
          blocked: _isBlocked('game_levels'),
          onTap: () {
            if (_isBlocked('game_levels')) {
              _showMemberDialog('闯关游戏');
              return;
            }
